...
_styles: >
    ...
    /* Responsive tables - ADD THIS SECTION */
    @media (max-width: 768px) {
      .l-body[style*="display: flex"] {
...
<div id="ref11">[11] Xiang Fu, Tian Xie, Nathan J. Rebello, Bradley D. Olsen, Tommi S. Jaakkola:
Simulate Time-integrated Coarse-grained Molecular Dynamics with Multi-scale Graph Networks. Trans. Mach. Learn. Res. 2023 (2023)</div>
<div id="ref12">[12] Steeven Janny, Aurélien Béneteau, Madiha Nadri, Julie Digne, Nicolas Thome, Christian Wolf:
EAGLE: Large-scale Learning of Turbulent Fluid Dynamics with Mesh Transformers. ICLR 2023</div>