...
<div class="intro-gif">
  <video controls loop muted playsinline preload="metadata" poster="{{ '/assets/Erwin_/static/images/kino_poster.jpg' | relative_url }}">
    <source src="{{ '/assets/Erwin_/static/images/kino.mp4' | relative_url }}" type="video/mp4" alt="Short video presentation of the paper." >
  </video>
</div>
  ...
  <p class="large-title" style="text-align: center; margin-bottom: 15px; font-weight: bold;">
    ...
    <div style="width: 100%; display: flex; gap: 3%; align-items: flex-start;">
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/sparse_attention/text.svg' | relative_url }}" 
             alt="Text input" 
             style="width: 100%; height: auto;">
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/sparse_attention/full.svg' | relative_url }}" 
             alt="Full attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Full attention</figcaption>
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/sparse_attention/sliding.svg' | relative_url }}" 
             alt="Sliding window attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Sliding window</figcaption>
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/sparse_attention/block.svg' | relative_url }}" 
             alt="Block attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Block attention</figcaption>
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/sparse_attention/random.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 100%; margin: 20px 0;">
    ...
    <div style="width: 100%; display: flex; gap: 3%; align-items: flex-start;">
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/point_attention_car/text.svg' | relative_url }}" 
             alt="Point cloud input" 
             style="width: 100%; height: auto;">
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/point_attention_car/full.svg' | relative_url }}" 
             alt="Full attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Full attention</figcaption>
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/point_attention_car/sliding.svg' | relative_url }}" 
             alt="Sliding window attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Sliding window</figcaption>
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/point_attention_car/block.svg' | relative_url }}" 
             alt="Block attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Block attention</figcaption>
      </figure>
      <figure style="width: 20%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/point_attention_car/random.svg' | relative_url }}" 
             alt="Random attention" 
             style="width: 100%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: center;">Random attention</figcaption>
      </figure>
  ...
  <div style="width: 80%; max-width: 1000px; margin: 20px 0;">
    ...
    <div style="width: 100%; position: relative; margin-bottom: 15px;">
      <figure style="width: 100%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/phys_attention.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  ...
  <div style="width: 100%; position: relative;">
    <figure style="width: 100%; margin: 0;">
      <img src="{{ '/assets/Erwin_/static/images/many_body_tree.svg' | relative_url }}" 
            alt="Many body with hierarchical trees" 
            style="width: 100%; height: auto;">
    </figure>
  </div>
  <!-- Footer section with example labels -->
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 70%; margin: 0px auto;">
    ...
    <div style="width: 70%; display: flex; justify-content: center; margin: 0 auto;">
      <figure style="width: 100%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/octree_vs_btree.svg' | relative_url }}" 
             alt="Tree comparison" 
             style="width: 100%; height: auto;">
      </figure>
    </div>
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 70%; margin: 0px 0;">
    ...
    <div style="width: 100%; display: flex; gap: 3%; align-items: flex-start;">
      <figure style="width: 100%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/bta.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 60%; margin: 20px 0;">
    ...
    <div style="width: 100%; display: flex; gap: 3%; align-items: flex-start; margin-bottom: 20px;">
      <figure style="width: 100%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/tree_rot_alt.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 64%; margin: 20px 0;">
    ...
    <div style="width: 100%; display: flex; gap: 3%; align-items: flex-start; margin-bottom: 20px;">
      <figure style="width: 100%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/coarsening.svg' | relative_url }}" 
  ...
  <div style="width: 100%; max-width: 1000px; margin: 20px 0;">
    ...
    <div style="width: 100%; display: flex; gap: 7%; align-items: flex-start;">
      <figure style="width: 38%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/mem_layout.svg' | relative_url }}" 
              alt="Memory layout in Erwin" 
              style="width: 100%; height: auto;">
      </figure>
      <figure style="width: 62%; margin: 0;">
        <img src="{{ '/assets/Erwin_/static/images/code.png' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 100%; margin: 20px 0;">
      <figure style="width: 100%; margin: 0; text-align: center;">
        <img src="{{ '/assets/Erwin_/static/images/scaling_and_rf.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 100%; margin: 20px 0;">
      <figure style="width: 100%; margin: 0; text-align: center;">
        <img src="{{ '/assets/Erwin_/static/images/md.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 100%; margin: 20px 0;">
      <figure style="width: 100%; margin: 0; text-align: center;">
        <img src="{{ '/assets/Erwin_/static/images/eagle.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 100%; margin: 20px 0;">
      <figure style="width: 100%; margin: 0; text-align: center;">
        <img src="{{ '/assets/Erwin_/static/images/bsa.svg' | relative_url }}" 
...
<div class="l-body" style="display: flex; justify-content: center;">
  <div style="width: 100%; margin: 20px 0;">
      <figure style="width: 100%; margin: 0; text-align: center;">
        <img src="{{ '/assets/Erwin_/static/images/haet.jpg' | relative_url }}" 
              alt="Ball Sparse Attention scheme" 
              style="width: 60%; height: auto;">
        <figcaption style="font-size: 1.0em; text-align: left;">
